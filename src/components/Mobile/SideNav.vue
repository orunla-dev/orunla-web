    ...
    <div class="w-3/4 z-50 bg-white relative shadow-md">
      ...
      <template v-if="user.uid">
        <div
          ...
          :class="
            tab === 'categories' ? 'font-bold bg-gray-400' : 'bg-gray-300'
          "
        ...
        <div
          class="bg-gray-300 px-5 py-2 h-52"
        ...
        <div class="bg-gray-200 px-5 py-2 h-52" v-if="tab === 'list'">
          ...
          <div class="my-5" v-else>
            <div class="text-center text-sm">
              ...
              Adding books to your list is a nice way to remind yourself of
      ...
      <router-link
        v-else
        class="absolute bottom-0 left-0 right-0 p-5 bg-primary text-white flex items-center gap-3 text-xl"
        :to="`/auth/login?continue=${$route.path}`"
      >
        <i class="icofont-sign-in text-2xl"></i>
        Log In
      </router-link>
    </div>
